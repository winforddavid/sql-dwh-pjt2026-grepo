...
### Building the Data Warehouse on Databricks (Data Engineering)

#### Objective
Develop a modern data warehouse using MS Azure and SQL to consolidate sales data, enabling analytical reporting and helping organisations make better informed decisions.
